...
<form style="height: 200%;" method="GET" action="../model/app_gravadb.php">
  ...
  <div class="form-group col-md-12">
	...
	<div class="form-group col-md-12">
		<h6 class="mb-12 "><label for="recipient-name" class="col-form-label" style="color: black;">Nome do Cliente:</label></h6>
	...
	<div class="form-group col-md-12">
		...
		<h7 class="mb-12 text-center"><label for="recipient-name" class="col-form-label" style="color: #5a5a5a;">(* No campo "Quantidade" voçê pode inserir o valores "1/2", no caso de meia porção !)</label></h7>
	</div>
